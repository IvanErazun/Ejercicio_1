...
public class AMainEjercicio1 {
  ...
  public static void main(String[] args) {
    ...
    ar.entdu.utn.frba.dds.ejercicio_01.DiaDeEntrenamiento dia1 = new ar.entdu.utn.frba.dds.ejercicio_01.DiaDeEntrenamiento();
    dia1.setNumero(1);
    dia1.agregarEjercicio(ejercicio1);
    dia1.agregarEjercicio(ejercicio2);

    ar.entdu.utn.frba.dds.ejercicio_01.DiaDeEntrenamiento dia2 = new ar.entdu.utn.frba.dds.ejercicio_01.DiaDeEntrenamiento();
    dia2.setNumero(2);
